...
import bearUrl from '../resources/ssabus_logo.png'
import leaves1Url from '../resources/leaves1.png'
import leaves2Url from '../resources/leaves2.png'
// import '../materials/layerMaterial''
import { LayerMaterial } from '../materials/layerMaterials'
...
function Experience() {
  ...
  const layers = [
    ...
    { texture: textures[3], x: 15, y: 0, z: 30, scaleFactor: 0.63, scale: scaleN },
  ...
  return (
    <group ref={group}>
      <Fireflies count={60} radius={80} colors={['orange']} />
